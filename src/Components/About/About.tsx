    ...
    <motion.div className="container">
      ...
      <div className="textWrapper">
        <motion.div className="textContainer" style={{ opacity: 1 }} >
          <motion.div style={{transform: `translate(${scrollContext.scrollPos*1500}px)` }}>
            <h1 className="aboutTitle" >Hello,<br />I'm <span>Franco</span></h1>
            <p className="aboutText">I'm an Argentina-based frontend web developer,<br />focused on reactive frameworks.</p>
              ...
              >
                <div>
                  ...
                  >
                    ...
                    Nisi quia, vero molestias accusamus voluptate ipsum dolore
                    numquam reiciendis? 
                  </p>
                </div>
              </motion.div>
