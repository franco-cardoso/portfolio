            ...
            <div className="contactContentWrapper">
                ...
                <div className="contacts">
                    <ContactCard
                        ...
                        icon={<MdEmail size={60} aria-label="Email icon" />}
                    />
                    <ContactCard
                        title={t("contact.phone")}
                        subtitle="+54 9 3446 66-7820"
                        icon={<MdPhone size={60} aria-label="Phone icon" />}
                    />
                </div>
                <div className="contacts">
                    <a href="https://www.linkedin.com/in/franco-cardoso-854442241/" rel="noreferrer" target={"_blank"}>
                        <ContactCard title="LinkedIn" subtitle="" icon={<IoLogoLinkedin size={60} aria-label="LinkedIn icon" />} />
                    </a>
                    <a href="https://github.com/franco-cardoso" rel="noreferrer" target={"_blank"}>
                        <ContactCard title="GitHub" subtitle="" icon={<IoLogoGithub size={60} aria-label="Github icon" />} />
                    </a>
                </div>
            </div>
        </section>
